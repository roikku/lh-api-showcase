...
public class DeparturesStatusPresenter extends AbstractStatusPresenter {

	private Logger logger = Logger.getLogger("DeparturesStatusPresenter");

	
	public DeparturesStatusPresenter (OperationsServiceAsync operationsService, HandlerManager eventBus, Display view) {
	...
	protected void fetchStatusData(AirportCode airport, String startDate, String endDate) {
		...
		operationsService.getDeparturesStatus(airport, startDate, endDate, new AsyncCallback<String>() {
			@Override
			...
			public void onSuccess(final String result) {
				display.setBusy(false);
				display.setJson(result, new DeparturesStatusResponseJsonParser());
			}
		});
	}
}
